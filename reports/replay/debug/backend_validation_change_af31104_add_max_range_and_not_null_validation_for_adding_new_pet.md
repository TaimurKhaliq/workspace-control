...
- case id: `backend_validation_change_af31104_add_max_range_and_not_null_validation_for_adding_new_pet`
...
- labels: `planner_overpredicted`, `planner_underpredicted`
- likely cause: Planner/proposal underpredicted exact files for an otherwise supported change.
- recommended fix area: `planner`
- why: Predicted files did not exactly match actual changed files. Predicted more files than actually changed.
...
- recipe exact_precision: 0.0909
- recipe exact_recall: 1.0
- recipe category_precision: 0.1667
- recipe category_recall: 1.0
- recipe high_signal_precision: 0.0909
- recipe high_signal_recall: 1.0
- matched recipes:
  - `petclinic_react_backend_validation_change` (backend_validation_change, structural=0.723, planner=0.0833)
  - `petclinic_react_ui_form_validation` (ui_form_validation, structural=0.9555, planner=0.0)
  - `petclinic_react_full_stack_ui_api` (full_stack_ui_api, structural=0.9156, planner=0.3182)
- suggested actions:
  - `spring-petclinic-reactjs/src/main/java/org/springframework/samples/petclinic/web/api/PetRequest.java` action=modify node=api_dto exists_in_parent=True matched_actual=True
  - `spring-petclinic-reactjs/src/main/java/org/springframework/samples/petclinic/web/api/PetResource.java` action=modify node=api_dto exists_in_parent=True matched_actual=False
  - `spring-petclinic-reactjs/src/main/java/org/springframework/samples/petclinic/web/PetController.java` action=inspect node=api_controller exists_in_parent=True matched_actual=False
  - `spring-petclinic-reactjs/src/main/java/org/springframework/samples/petclinic/model/Owner.java` action=modify node=domain_model exists_in_parent=True matched_actual=False
  - `spring-petclinic-reactjs/src/main/java/org/springframework/samples/petclinic/model/Pet.java` action=modify node=domain_model exists_in_parent=True matched_actual=False
...
- combined exact_precision: 0.0455
- combined exact_recall: 1.0
- combined category_precision: 0.125
- combined category_recall: 1.0
- combined high_signal_precision: 0.0455
...
- graph edge count: 117
- graph node counts: `{'api_controller': 9, 'api_dto': 7, 'app_shell': 1, 'detail_component': 1, 'domain_model': 17, 'edit_surface': 2, 'event_consumer': 1, 'form_component': 9, 'frontend_entrypoint': 1, 'frontend_type': 1, 'landing_page': 1, 'list_component': 2, 'page_component': 8, 'public_html': 1, 'repository': 4, 'service_layer': 2, 'shared_component': 8, 'static_asset': 1}`
