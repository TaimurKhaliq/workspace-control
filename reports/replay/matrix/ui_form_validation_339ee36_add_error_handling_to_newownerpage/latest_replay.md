...
- recipe matched files: `spring-petclinic-reactjs/client/src/components/owners/NewOwnerPage.tsx`, `spring-petclinic-reactjs/client/src/types/index.ts`
...
| recipe suggestions only | 9 | 2 | 0.22/0.67 | 0.50/1.00 | 0.22/0.67 |
