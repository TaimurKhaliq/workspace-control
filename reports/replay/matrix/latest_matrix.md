...
| recipe suggestions only | 0.36/0.65 | 0.51/0.84 | 0.36/0.72 |
| combined | 0.34/0.66 | 0.50/0.84 | 0.34/0.73 |
...
| `backend_validation_change_af31104_add_max_range_and_not_null_validation_for_adding_new_pet` | backend_validation_change | good | `af31104` | True | 1 | 0.00/0.00 | 0.08/1.00 | 0.04/1.00 | 0.00/0.00 | 0.17/1.00 | 0.12/1.00 | 0.00/0.00 | 0.08/1.00 | 0.04/1.00 | True (improved_recall) | `spring-petclinic-reactjs/src/main/java/org/springframework/samples/petclinic/web/api/PetRequest.java` |
